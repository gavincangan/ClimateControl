...
// CAN0 wake up			(software int 3)
#pragma interrupt	_can0_wakeup(vect=3)
void _can0_wakeup(void){}

// CAN0 receive complete	(software int 4)
#pragma interrupt	_can0_receive(vect=4)
void _can0_receive(void){}

// CAN0 trance  complete	(software int 5)
#pragma interrupt	_can0_trance(vect=5)
void _can0_trance(void){}

// CAN0 error			(software int 6)
#pragma interrupt	_can0_error(vect=6)
